...
<!-- -->
    ...
    ## [1] "1st approach time: 21.71 vs 2nd approach time: 12"
...
<br> Now, we can give the monthly ratio of `NAs` and/or the year ratio and understand the status of the `NAs`
