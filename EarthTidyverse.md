...
<!-- -->
    ...
    ## [1] "1st approach time: 20.83 vs 2nd approach time: 12"
...
``` r
countryinfo <- inner_join(distinct(thresdata, STAID), select(stationsData, STAID, CN, STANAME, latUpd, longUpd), by = "STAID")
```
...
![](EarthTidyverse_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-26-1.png)
